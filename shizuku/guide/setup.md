...
[Source](https://github.com/Rihttpsps/websites/pull/79#issue-1751837442)
...
4. Enable "Wireless debugging"<br><br><img :src="$withBase('/images/enable_wireless_debugging.png')" style="max-width:320px;width:1000%">
